...
export default async function handler(req, res) {
  console.log(
    `[OPTIMIZE INDEXES] ${req.method} /api/admin/optimize-database-indexes`,
  );
  ...
  try {
    ...
    try {
      ...
      indexResults.push({
        collection: "stories",
        index: "published_createdAt_stats",
        status: "created",
      });
      ...
      indexResults.push({
        collection: "stories",
        index: "published_category_stats",
        status: "created",
      });
      ...
      indexResults.push({
        collection: "stories",
        index: "published_accessLevel_stats",
        status: "created",
      });
      ...
      indexResults.push({
        collection: "stories",
        index: "published_likeCount_stats",
        status: "created",
      });
      ...
      indexResults.push({
        collection: "stories",
        index: "published_averageRating_stats",
        status: "created",
      });
    ...
    try {
      ...
      indexResults.push({
        collection: "comments",
        index: "storyId_createdAt_stats",
        status: "created",
      });
    } catch (commentIndexError) {
      console.log(
        "[OPTIMIZE INDEXES] Comment indexes:",
        commentIndexError.message,
      );
      indexResults.push({
        collection: "comments",
        error: commentIndexError.message,
      });
    }
    ...
    try {
      ...
      console.log(
        "[OPTIMIZE INDEXES] Rating indexes:",
        ratingIndexError.message,
      );
      indexResults.push({
        collection: "ratings",
        error: ratingIndexError.message,
      });
    }
    ...
    try {
      ...
      indexResults.push({
        collection: "loginlogs",
        index: "userId_timestamp_stats",
        status: "created",
      });
    } catch (loginLogIndexError) {
      console.log(
        "[OPTIMIZE INDEXES] LoginLog indexes:",
        loginLogIndexError.message,
      );
      indexResults.push({
        collection: "loginlogs",
        error: loginLogIndexError.message,
      });
    }

    // === USER STORY READ COLLECTION INDEXES ===
    console.log(
      "[OPTIMIZE INDEXES] Optimizing UserStoryRead collection indexes...",
    );
    ...
    try {
      ...
      console.log(
        "[OPTIMIZE INDEXES] UserStoryRead indexes:",
        readIndexError.message,
      );
      indexResults.push({
        collection: "userstoryreads",
        error: readIndexError.message,
      });
    }
    ...
    try {
      ...
      indexResults.push({
        collection: "errorlogs",
        index: "endpoint_timestamp_stats",
        status: "created",
      });
    } catch (errorLogIndexError) {
      console.log(
        "[OPTIMIZE INDEXES] ErrorLog indexes:",
        errorLogIndexError.message,
      );
      indexResults.push({
        collection: "errorlogs",
        error: errorLogIndexError.message,
      });
    }

    const successCount = indexResults.filter(
      (r) => r.status === "created",
    ).length;
    const errorCount = indexResults.filter((r) => r.error).length;

    console.log(
      `[OPTIMIZE INDEXES] ✅ Index optimization complete: ${successCount} created, ${errorCount} errors`,
    );
