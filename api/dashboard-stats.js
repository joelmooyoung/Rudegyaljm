...
export default async function handler(req, res) {
  ...
  try {
    console.log("[DASHBOARD STATS] Executing comprehensive dashboard aggregations...");
    ...
    console.log(`[DASHBOARD STATS] All aggregations completed in ${queryTime}ms`);
    ...
    console.log(`[DASHBOARD STATS] ✅ Comprehensive dashboard data generated:`, {
