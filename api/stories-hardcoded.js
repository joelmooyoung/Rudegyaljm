...
export default function handler(req, res) {
  ...
  const stories = [
    ...
    },
    {
      ...
      content:
        "<p>Elena had always been the best student in Professor Martinez's literature class, but tonight's private study session was about to become something much more intimate...</p><p>As rain pattered against the library windows, she found herself alone with the man who had been the subject of her secret fantasies for months.</p><p>'You understand the poetry better than any student I've ever taught,' he said, moving closer. 'But I wonder if you understand the passion behind the words.'</p>",
      excerpt:
