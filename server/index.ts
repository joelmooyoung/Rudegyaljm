  ...
  app.get("/api/stories", async (req, res) => {
    ...
    const reliableStories = [
      ...
      },
      {
        ...
        content: "<h1>After Hours</h1><p>Elena had always been the best student in Professor Martinez's literature class, but tonight's private study session was about to become something much more intimate...</p><p>As rain pattered against the library windows, she found herself alone with the man who had been the subject of her secret fantasies for months.</p><p>'You understand the poetry better than any student I've ever taught,' he said, moving closer. 'But I wonder if you understand the passion behind the words.'</p><h2>The Lesson:</h2><p>The leather-bound book of sonnets lay forgotten on the mahogany desk as Professor Martinez traced a line from Neruda with his finger, his eyes never leaving Elena's face.</p><p>'Poetry is about desire,' he whispered. 'About the space between what we say and what we mean.'</p>",
        excerpt: "A brilliant student discovers that some lessons can only be learned after hours.",
        author: "Carmen Silva",
        category: "Forbidden",
        tags: ["forbidden", "academic", "intellectual", "tension", "literature"],
        accessLevel: "premium",
        isPublished: true,
    ...
    try {
      ...
      console.error("📚 [STORIES] Database failed (expected):", dbError.message);
    }
